...
;
; Author: Jailson Lima
; Description: ASM HTTP Server is an open source project for the development of a high performance http server for static files, and entirely written in Assembly language.
; Version: 0.0.1
;
; Compiling:
; fasm server.asm
...
section '.data' data readable writeable
   ...
   request rb 128
   response db 'HTTP/1.1 200 OK', 13, 10, 'Content-Type: text/plain; charset=utf-8', 13, 10, 'Connection: keep-alive', 13, 10, 'Content-Length: 15', 13, 10, 13, 10, 'ASM HTTP Server', 0
   characters_written dd 0
   run_message db 'server is running...', 10, 0
   accept_message db 'GET', 10, 0
